...
module.exports = 
{
  ...
  "paths": {
    "/EasyTV_HBMM_Restful_WS/personalize/login": {
      "post": {
        "tags": [
          "Personalize login"
        ],
    ...
    "/EasyTV_HBMM_Restful_WS/personalize/logout": {
      "post": {
        "tags": [
          "Personalize logout"
        ],
    ...
    "/EasyTV_HBMM_Restful_WS/interaction/suggestions": {
      "get": {
        "tags": [
          "Interaction suggestions"
        ],
        "description": "Get user profile modification suggestions.",
        "responses": {
          "200": {
            "description": "Return user profile modification suggestions.",
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/modification_suggestions"
                }
              }
            }
          },
  ...
  "components": {
    ...
    "schemas": {
      ...
      "preferences": {
        ...
        "properties": {
          "http://registry.easytv.eu/application/control/csGazeAndGestureControlCursorGuiLanguage": {
            "type": "string",
            "description": "The gaze and gesture control interface lanugage"
          },
          "http://registry.easytv.eu/application/control/csGazeAndGestureControlCursorGuiTextSize": {
            "type": "string",
            "description": "The gaze and gesture control interface lanugage text size"
          },
          ...
          "http://registry.easytv.eu/application/cs/accessibility/audio/description": {
            "type": "string",
            "description": "Enable/disable audio description"
          },
          "http://registry.easytv.eu/application/cs/accessibility/detection/character": {
            "type": "string",
            "description": "Enable/disable character recognition"
          },
      ...
      "modification_suggestions": {
        "type": "object",
        "properties": {
          "profile_modification_suggestions": {
            "$ref": "#/components/schemas/preferences"
          }
        }
      },
